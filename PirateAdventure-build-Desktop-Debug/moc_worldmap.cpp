...
**
** Created: Sun Dec 1 19:18:39 2013
...
static const char qt_meta_stringdata_worldmap[] = {
    "worldmap\0\0on_pushButton_clicked()\0"
};
...
const QMetaObjectExtraData worldmap::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject worldmap::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_worldmap,
      qt_meta_data_worldmap, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &worldmap::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_worldmap))
