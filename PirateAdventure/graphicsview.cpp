    ...
    QGraphicsView(parent)
{
    ...
    wigglyWidget->setText("Pirate Adventure");
    ...
    wigglyWidget->setText("I'm ready to battle any pirate to get my gold!");
    ...
    bg1 = scene.addPixmap(QPixmap(":/images/images/bg1.jpg"));
    bg1->setZValue(-1);
    bg1->setGraphicsEffect(graphicsOpacityEffect1);
    bg1->setVisible(true);

    bg2 = scene.addPixmap(QPixmap(":/images/images/bg2.JPG"));
    bg2->setZValue(-1);
    bg2->setGraphicsEffect(graphicsOpacityEffect2);
    bg2->setVisible(true);

    bg3 = scene.addPixmap(QPixmap(":/images/images/bg3.JPG"));
    bg3->setZValue(-1);
    ...
    flower = scene.addPixmap(QPixmap(":/images/Works/flower.jpg"));
    ...
    graphicsTextItem = scene.addText("Welcome to pirate adventure,\n I'm Patchy the pirate and \n I'm ready to expore this island");
    graphicsTextItem->setPos(100,-300);
    graphicsTextItem->setFont(QFont("", 12, QFont::Bold));
