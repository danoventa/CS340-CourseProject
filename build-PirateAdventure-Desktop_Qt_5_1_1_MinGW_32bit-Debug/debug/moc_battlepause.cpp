...
#include "../../../../../../../Desktop/CS340-CourseProject/PirateAdventure/battlepause.h"
...
struct qt_meta_stringdata_BattlePause_t {
    QByteArrayData data[3];
    char stringdata[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_BattlePause_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_BattlePause_t qt_meta_stringdata_BattlePause = {
    {
QT_MOC_LITERAL(0, 0, 11),
QT_MOC_LITERAL(1, 12, 21),
QT_MOC_LITERAL(2, 34, 0)
    },
    "BattlePause\0on_pushButton_clicked\0\0"
};
...
const QMetaObject BattlePause::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_BattlePause.data,
      qt_meta_data_BattlePause,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BattlePause.stringdata))
