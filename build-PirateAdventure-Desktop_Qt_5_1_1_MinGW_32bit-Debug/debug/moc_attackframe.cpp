...
#include "../../../../../../../Desktop/CS340-CourseProject/PirateAdventure/attackframe.h"
...
struct qt_meta_stringdata_attackframe_t {
    QByteArrayData data[5];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_attackframe_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_attackframe_t qt_meta_stringdata_attackframe = {
    {
...
QT_MOC_LITERAL(4, 40, 2)
    ...
    "attackframe\0keyReleaseEvent\0\0QKeyEvent*\0"
    "ke\0"
};
...
const QMetaObject attackframe::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_attackframe.data,
      qt_meta_data_attackframe,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_attackframe.stringdata))
